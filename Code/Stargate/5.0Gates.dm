...
obj/Stargate/proc
	Connect(obj/Stargate/Target)
		...
		viewers(Target)<<sound("Sounds/locked.ogg")
		sleep(20)
		sleep(10)
		if(outgoing||incomming||Target.incomming||Target.outgoing)return
		outgoing=Target
		Target.incomming=src
		viewers(src)<<sound('Sounds/dhd_press7.ogg',volume=50)
		viewers(Target)<<sound('Sounds/dhd_press7.ogg',volume=50)
	...
	Idle(obj/Stargate/Target)
		...
		//	gateopen = 1
			sleep(10)
			viewers(src)<<sound('Sounds/gate_horizon.ogg')
			viewers(Target)<<sound('Sounds/gate_horizon.ogg')
			X=0
	...
	Disengage()
		...
		viewers(src)<<sound('Sounds/gate_shutdown.ogg',0,0,7,volume=50)
