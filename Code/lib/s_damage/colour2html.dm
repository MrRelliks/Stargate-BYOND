...
world/New()
	...
	HtmlAssosciate("greenred","adff2f")
	...
	HtmlAssosciate("lightgoldenrodred","fafad2")
	...
	HtmlAssosciate("lightred","ffffe0")
	...
	HtmlAssosciate("red","ffff00")
	HtmlAssosciate("redgreen","a9cd32")
